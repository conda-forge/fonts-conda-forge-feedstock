About fonts-conda-forge-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fonts-conda-forge-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7563&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fonts-conda-forge-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fonts-conda-forge` can be installed with `conda`:
...
```
mamba install fonts-conda-forge
```

It is possible to list all of the versions of `fonts-conda-forge` available on your platform with `conda`:
...
```
mamba search fonts-conda-forge --channel conda-forge
```
...
mamba repoquery search fonts-conda-forge --channel conda-forge

# List packages depending on `fonts-conda-forge`:
mamba repoquery whoneeds fonts-conda-forge --channel conda-forge

# List dependencies of `fonts-conda-forge`:
mamba repoquery depends fonts-conda-forge --channel conda-forge
```
